<div>
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-semibold">Criar Feriado</h1>
        </div>
    </div>
    ...
    <div class="mt-6 flex justify-between">
        <x-ui-button class="hover:transition-all hover:duration-300 hover:scale-110" wire:click="createHoliday">Salvar Feriado</x-ui-button>
